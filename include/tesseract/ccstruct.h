...
class CCStruct : public CUtil {
 public:
  ...
  static double kDescenderFraction;  // = 0.25;
  static double kXHeightFraction;    // = 0.5;
  static double kAscenderFraction;   // = 0.25;
  // Derived value giving the x-height as a fraction of cap-height.
  static double kXHeightCapRatio;    // = XHeight/(XHeight + Ascender).

  static void reinit(double desc_frac, double asc_frac, double height_frac );
